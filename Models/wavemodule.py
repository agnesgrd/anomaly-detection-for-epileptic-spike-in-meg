...
class Dwtconv(nn.Module):
    """Related modules of Dense Wave."""
    def __init__(self, node_feature, outC1, outC2):
        super(Dwtconv, self).__init__()

        self.dwt1 = DWT1DForward(J=1, wave = params.pywt_family, mode='symmetric')
        ...
        self.dwt2 = DWT1DForward(J=1, wave = params.pywt_family, mode='symmetric')
...
class DWTCompose(nn.Module):
    """Apply the multilevel DWT to the original time series in the time domain,
    return the frequency components at different time scales."""
    def __init__(self, node):
        super(DWTCompose, self).__init__()
        self.dwt1 = DWT1DForward(J=1, wave=params.pywt_family, mode='zero')
        self.dwt2 = DWT1DForward(J=1, wave=params.pywt_family, mode='zero')
        self.dwt3 = DWT1DForward(J=1, wave=params.pywt_family, mode='zero')
...
class IDWT(nn.Module):
    def __init__(self):
        ...
        self.idwt1 = DWT1DInverse(wave=params.pywt_family, mode='zero')
